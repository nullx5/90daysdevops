  ...
  static checkLevelUpCondition(assets, variables, ctx) {
    ...
    assets.props.pellets.forEach((pellet) => {
      ...
      if (eatenPellets === assets.props.pellets.length) {
        ...
        variables.level++; // Incrementar el nivel
        console.log('🎯 Level completed! Level:', variables.level);
        
        // Terminar el juego con victoria en lugar de subir de nivel
        // Esto permite capturar el tiempo correctamente
